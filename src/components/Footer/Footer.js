...
const BASE_URL = "https://my-json-server.typicode.com/gregos12/repos/footer";
                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                <div className="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                    {/* Copyright Left */}
                                    <div className="copyright-left">©2022 OpenRare, All Rights Reserved.</div>
                                    {/* Copyright Right */}
                                    <div className="copyright-right">Made with <i className="fas fa-heart" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
